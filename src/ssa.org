...
**** TODO What in the world is the FSM's input??
*** system state
...
* [#B] Visualization
** displaying a graph
#+BEGIN_SRC python :tangle "ssa/visualization/glob.py"
  import pygame
...
#+BEGIN_SRC python :tangle "ssa/testing/generators/GraphGeneratorUtil.py"
  import networkx
  import random
