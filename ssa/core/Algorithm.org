...
:END:
#+BEGIN_SRC xml :tangle "ind-set.ssax" :padline no
  <?xml version="1.0"?>
  <bundle xmlns="https://github.com/vermiculus/ssa-tool">
  <algorithm name="Independent Set">
    <rule description="If a node is marked and shouldn't be, unmark it."
            predicate="marked_and_neighbor_marked.py">
      <move file="unmark.py" />
    </rule>
    <rule description="If a node is unmarked and can be, mark it."
